...
def most_similar_docs():
    ...
    result = paraphrases.loc[paraphrases['similarity']==paraphrases['similarity'].max()].squeeze().values
    return result[1],result[2],result[3]# Your Answer Here
...
def label_accuracy():
    ...
    for i in range(len(paraphrases)):
        if paraphrases['similarity'][i] > 0.75:
...
# Your code here:
ldamodel = gensim.models.ldamodel.LdaModel(corpus=corpus,num_topics=10,random_state=34,passes=25,id2word=id_map)
...
def topic_distribution():
    ...
    # Your Code Here
    doc = gensim.matutils.Sparse2Corpus(new_doc_vectorized,documents_columns=False)
    return list(ldamodel.get_document_topics(doc))[0]# Your Answer Here
...
def topic_names():
    ...
    return ['Education','Automobiles','Computers & IT','Religion','Travel','Sports','Sports','Health','Society & Lifestyle','Computers & IT','Science',]
